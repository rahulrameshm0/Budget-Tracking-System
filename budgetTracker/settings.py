...
SECRET_KEY = 'django-insecure-2jb7@60)ata6#29@s+60=1*a3cds7gzof2awy#*gbzb_boaxfy'
...
DATABASES = {
   'default':dj_database_url.config(
        default='postgresql://budget_tracker_3bj2_user:qQQQETVe4TDbxGXlDHldnwVoBeY8EYK4@dpg-d1tapbemcj7s73d5i40g-a.oregon-postgres.render.com:5432/budget_tracker_3bj2',
        conn_max_age = 0,
        ssl_require = True
   )
}
